...
public class DischargeRepository {
    private static final Set<Integer> ALLOWED_SIZES = Set.of(10, 20, 50, 100, 200);
    ...
    private String buildPageSql(String scope) {
        return """
                SELECT d.*, e.id AS encounter_id, e.inpatient_no, e.admission_times, e.patient_name,
                       e.gender, e.primary_diagnosis, e.secondary_diagnosis, e.medical_insurance_type, e.admitted_at, e.doctor_name_source, e.doctor_employee_no, dpt.department_name,
