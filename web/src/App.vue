  ...
  <el-container v-else class="app-shell">
    ...
    <el-container class="workspace">
      <el-header class="topbar">
        ...
        <div class="user-chip"><a href="/help/康复医院运营管理系统用户手册_V1.1.0.docx" download>？ 帮助手册</a><span class="topbar-separator">|</span><span class="version-chip">V{{ appVersion }}</span><span class="topbar-separator">|</span><el-dropdown><span class="user-menu"><span class="user-avatar">{{ (currentUser || '未登录').slice(0, 1).toUpperCase() }}</span><span>{{ currentUser || '未登录' }}</span><span>⌄</span></span><template #dropdown><el-dropdown-menu><el-dropdown-item><router-link to="/system/change-password">修改密码</router-link></el-dropdown-item><el-dropdown-item divided @click="logout">退出</el-dropdown-item></el-dropdown-menu></template></el-dropdown></div>
      </el-header>
